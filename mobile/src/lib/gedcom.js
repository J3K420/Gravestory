...
// the web copy in js/gedcom.js. Only the module wrapper differs (web is a classic
// script that attaches to window; this is an ES module). Mirrors how biography.js
// / SYMBOL_CONTEXT are kept identical across the two codebases. Pure + deterministic
// (no I/O, no Date.now, '\n' line endings) so the two platforms produce identical
// output for the same story.
//
...
export { buildGedcom, gedcomFilename };
